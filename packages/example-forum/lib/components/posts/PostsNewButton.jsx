...
const PostsNewButton = (props, context) => {
  ...
  const button = <Components.Button className="posts-new-button" bsStyle="primary"><Components.Icon name="new"/> <FormattedMessage id="posts.new_post"/></Components.Button>;
  return (
